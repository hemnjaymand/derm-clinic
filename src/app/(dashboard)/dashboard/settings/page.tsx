...
export default async function SettingsPage() {
  ...
  return (
    <div className="space-y-8" dir="rtl">
      {/* هدر صفحه */}
      <div className="flex flex-col gap-1 border-b border-emerald-200/60 pb-6">
        <h1 className="text-2xl font-bold tracking-tight text-emerald-950">تنظیمات کلینیک</h1>
        <p className="text-sm text-muted-foreground">
          مدیریت اطلاعات عمومی، راه‌های ارتباطی و امنیت حساب کاربری
        </p>
      </div>

      {/* سیستم تب‌بندی تبدیل‌شده به سایدبار کناری */}
      <Tabs defaultValue="general" className="flex flex-col md:flex-row gap-8 lg:gap-12" orientation="vertical">
        ...
        <div className="w-full md:w-64 shrink-0">
          <TabsList className="flex flex-col h-auto w-full bg-transparent p-0 gap-2 items-stretch">
            ...
            <TabsTrigger 
              value="general" 
              className="justify-start px-4 py-3 h-12 text-right data-[state=active]:bg-emerald-100/70 data-[state=active]:text-emerald-950 data-[state=active]:shadow-none rounded-lg border border-transparent data-[state=active]:border-emerald-300 transition-all font-medium text-muted-foreground"
            >
              <Building2 className="ml-3 h-5 w-5" />
              <span>تنظیمات پایه و عمومی</span>
            </TabsTrigger>
        ...
        <div className="flex-1 w-full min-w-0">
          ...
          <TabsContent value="general" className="m-0 space-y-6 focus-visible:outline-none focus-visible:ring-0">
            <div className="rounded-2xl border border-emerald-200/80 bg-emerald-50/30 p-6 shadow-sm md:p-8">
              <div className="mb-6 flex items-center gap-3 border-b border-emerald-200/60 pb-4">
                ...
                <div>
                  <h2 className="font-semibold text-emerald-950">تنظیمات عمومی سایت</h2>
          ...
          <TabsContent value="security" className="m-0 space-y-6 focus-visible:outline-none focus-visible:ring-0">
            <div className="rounded-2xl border border-emerald-200/80 bg-emerald-50/30 p-6 shadow-sm md:p-8">
              <div className="mb-6 flex items-center gap-3 border-b border-emerald-200/60 pb-4">
                ...
                <div>
                  <h2 className="font-semibold text-emerald-950">تغییر رمز عبور پنل</h2>
                  <p className="text-xs text-muted-foreground mt-1">
