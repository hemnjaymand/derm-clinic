...
// //  کامپوننت کلاینت (فرم)
// // ============================================================
// function ConsultationFormClient({
//   settings,
// }: {
...
//       {/* ============================================================
//           پس‌زمینه: ترکیب گرادینت بنفش + تصویر (در صورت وجود)
//           ============================================================ */}
//       <div className="absolute inset-0 z-0">
//         {/* گرادینت پایه (همیشه نمایش داده می‌شود) */}
//         <div className="absolute inset-0 bg-gradient-to-br from-primary/90 via-primary/60 to-primary/30" />
...
//                   className="group relative w-full overflow-hidden rounded-xl bg-gradient-to-r from-secondary to-secondary/80 py-3.5 font-medium text-secondary-foreground transition-all hover:scale-[1.02] hover:shadow-lg hover:shadow-secondary/25 disabled:opacity-70 disabled:hover:scale-100"
//                 >
...
//                     ) : (
//                       <>
//                         {settings.buttonText || "ثبت درخواست"}
